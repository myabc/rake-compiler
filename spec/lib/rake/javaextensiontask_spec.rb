  ...
  context '(tasks)' do
    ...
    context '(one extension)' do
      ...
      context 'tmp/{platform}/extension_one/extension_one.jar' do
        ...
        it "should depend on 'ext/extension_one/source.java'" do
          Rake::Task["tmp/#{@platform}/extension_one/#{@ext_bin}"].prerequisites.should include("ext/extension_one/source.java")
        end
      end
